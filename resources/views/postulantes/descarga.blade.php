                    ...
                    <div class="col-md-12"><br><br>
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
                                        <a type="button" class="btn btn-danger" href="/" style="float: left;"><i
                                            class="fa fa-arrow-left"></i> Inicio</a>
                                    </div>
                                    <div class="col">
                                        <a type="button" class="btn btn-success" href="/downloadsHNWSBKEJS"><i
