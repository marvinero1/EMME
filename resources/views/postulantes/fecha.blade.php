                ...
                <div class="bs-stepper-content"><br>
                    <div id="test-l-1" class="content">
                        @if(Session::has('message'))
                            ...
                            <button class="btn btn-warning" onclick="stepper1.next()"><i class="fa fa-arrow-right"></i> Siguiente</button>
                        @endif
                    ...
                    <div id="test-l-2" class="content" active>
                        <div class="col-md-6">
                            <div class="h-100 d-flex flex-column justify-content-center text-center p-2 wow" data-wow-delay="0.6s">
                                ...
                                <button class="btn btn-warning" onclick="getValueInput()">
                                    <i class="fa fa-calendar"></i>&nbsp; Validar Fecha</button>
                            </div>
                            <script>
                                function getValueInput() {
                                    let error = "¡OBSERVADO POR SOBREPASAR LA EDAD DE POSTULACIÓN!";
                    ...
                    <div id="test-l-3" class="content">
                        ...
                        <form action="{{route('postulante.store')}}" method="POST">
                            ...
                            <div class="col-12 col-sm-6 inpt">
                                <span class="form form-group">Fecha Nacimiento</span>
                                <input type="date" class="form-control border-inpt" placeholder="Fecha Nacimiento"
                                    name="fecha_nacimiento" style="text-transform: uppercase;" style="height: 55px;">
                            </div>
                            <div class="col-12 col-sm-6 inpt">
                                <span class="form form-group"><br></span>
                                <input type="number" class="form-control border-inpt" placeholder="Edad *"
                                    name="edad" style="text-transform: uppercase;" style="height: 55px;"
                                    required>
                            </div>
                            <div class="col-12 col-sm-6 inpt">
                            ...
                            <div class="col-12 col-sm-6 inpt">
                                <input type="number" class="form-control border-inpt" placeholder="Whatsapp *"
                                    name="whatsapp" style="text-transform: uppercase;" style="height: 55px;" required>
                            </div>
                            <style>
                                .border-inpt{
                            ...
                            <div class="col-12">
                                <input type="email" class="form-control border-inpt"
                                    placeholder="CORREO ELECTRONICO *" name="email" style="height: 55px;"  required>
                            </div>
                            <input type="text" value="{{ $codigo_id ?? '' }}" name="codigo_id" hidden>
                            <div class="col-12">
                                <button class="btn btn-warning w-100 py-3" type="submit"><i
